...
async function seedWords() {
  ...
  if (count > 0) {
    console.log(`📊 Database already has ${count} words`)
    return
  }
  ...
  const basicWords = [
    ...
    { word: 'school', phonetic: '/skuːl/', meanings: [{ partOfSpeech: 'n.', definition: 'a place for learning', translation: '学校' }], examples: [{ sentence: 'I go to school.', translation: '我去上学。' }], difficulty: 1 },
    { word: 'teacher', phonetic: '/ˈtiːtʃə/', meanings: [{ partOfSpeech: 'n.', definition: 'a person who teaches', translation: '老师' }], examples: [{ sentence: 'My teacher is nice.', translation: '我的老师很好。' }], difficulty: 1 },
    { word: 'student', phonetic: '/ˈstjuːdənt/', meanings: [{ partOfSpeech: 'n.', definition: 'a person who learns', translation: '学生' }], examples: [{ sentence: 'I am a student.', translation: '我是一名学生。' }], difficulty: 1 },
    { word: 'friend', phonetic: '/frend/', meanings: [{ partOfSpeech: 'n.', definition: 'a person you like', translation: '朋友' }], examples: [{ sentence: 'He is my friend.', translation: '他是我的朋友。' }], difficulty: 1 },
    { word: 'family', phonetic: '/ˈfæməli/', meanings: [{ partOfSpeech: 'n.', definition: 'parents and children', translation: '家庭' }], examples: [{ sentence: 'I love my family.', translation: '我爱我的家庭。' }], difficulty: 1 },
  ]
